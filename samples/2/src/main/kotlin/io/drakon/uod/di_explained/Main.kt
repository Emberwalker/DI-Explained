...
class Main {
    ...
    fun start(injector: Injector) {
        ...
        webSocket("/ws", injector.getInstance(ClickerWebSocket::class.java))
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val injector = Guice.createInjector(GUICE_PRODUCTION)
            val m = injector.getInstance(Main::class.java)
            m.start(injector)
        }
    }
